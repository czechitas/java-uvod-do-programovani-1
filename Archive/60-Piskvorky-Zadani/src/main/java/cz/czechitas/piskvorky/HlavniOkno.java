...
public class HlavniOkno extends JFrame {
    ...
    private void priKliknutiNaBunku() {
        // TODO: Naprogramovat akci pri kliknuti na bunku

        // Mame k dispozici tyto prikazy:
        int cisloRadku, cisloSloupce;
        String textBunky;
        cisloRadku = getSelectedRow();
        cisloSloupce = getSelectedColumn();
        setCellText("O", 5, 2);
        textBunky = getCellText(5, 2);
    }
